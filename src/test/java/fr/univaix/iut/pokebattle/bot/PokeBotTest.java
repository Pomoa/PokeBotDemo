...
public class PokeBotTest {
    ...
    public final void testAskHelloFromFollower()
        ...
        pokeBot = new PokeBot("pokebattlePUTest");
        assertEquals("@Tristan Hi @Tristan, I am Abo.",
                pokeBot.ask(new Tweet("Tristan", "Hi, how are you ?")));
    }

    @Test
    public final void testAskHelloFromNoOne()
            throws CloneNotSupportedException {
        pokeBot = new PokeBot("pokebattlePUTest");
        assertEquals("Hi, I am Abo.",
                pokeBot.ask(new Tweet("Hi, how are you ?")));
